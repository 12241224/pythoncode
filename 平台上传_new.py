...
class ElectricityPricePredictorSklearn:
    ...
    def fit(self, data, n_estimators=None):
        ...
        # 合并为训练矩阵
        X, y_flat = self.create_sequences(X_price, X_features)
...
def main(csv_path: str, model_out: str):
    ...
    predictor = ElectricityPricePredictorSklearn(lookback=168 * 2, forecast_horizon=168 * 2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out', type=str, default='model.pkl', help='输出模型路径 (.pkl)')
