...
PREDICTION_END_DATE = '2024-05-05'
...
# =================== 结果保存与可视化 ===================
def save_prediction_with_actuals(prediction_df, actual_df, file_path):
    try:
        combined = pd.merge(
            prediction_df,
...
def main():
    ...
    try:
       ...
       # 合并与评估，并重命名列以避免冲突
        ...
        common_df[feature + '_Pred'], common_df[feature]
    )

        # 保存到 Excel
        save_prediction_with_actuals(prediction_df, actual_df, OUTPUT_EXCEL)
